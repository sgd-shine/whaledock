...
当前稳定下载版是 [`v0.5.0`](https://github.com/sgd-shine/whaledock/releases/tag/v0.5.0)。v0.5 给鲸坞加了两件可以完全自定义的东西，**都不需要写代码**。
...
- **v0.5.0**：批次 13 的桌面宠物与皮肤主题，已实现、过三平台 CI 并公开发布，是当前稳定下载版。宠物包与主题包都是纯静态资源，不执行包内代码、不联网下载。宠物包热重载、多只同屏与点击查看任务详情保留为 P2。
