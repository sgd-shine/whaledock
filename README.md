...
本地统一 `npm run smoke` 为 **233 PASS / ALL PASS**，正式 tag 提交的三平台 CI 全绿，八项 Release 资产已回读。但**宠物动效、透明背景、鼠标穿透与四套主题的实际配色都还没有人工目视验收**，只有代码与启动日志证据；人工体验项见 [第二阶段总验收清单](docs/第二阶段总验收清单-2026-08-16.md)，完整遗留见 [遗留清单](docs/遗留清单-2026-08-16.md)。Windows 与 Intel Mac 全线未真机；macOS 仍未签名未公证。
